...
public class Spotify_jsonobject_api {
	String token;
	String user_id;
	String playlist_id;
	...
	public void getToken() {
		token = "Bearer BQCCpZOqZQVVrm61Wl2l9AYbXdjpG4Ai8cV1qS3fFjnkOvCAlMIWDFHlVAQ_9lSpf3quOtPGp-1Nz5yJOrgGVE7HGtRPHRfhoCDYJYSa6_dhscvQey0yQkSnXfzcobou6o-chJ7wNouaHH8MmePC6p3K_vPkqYKYGoiDdWVwVhMmKPkdt-aQofJSkmLoaSSdaU5yxVeTWBcjrHdC7Iq0ozABuPCeLo6ScdYIp4mT3kJeUVAmOutdsFz_wF-Hv_2g9hQ0dXU";
	}
	...
	public void Create_Playlist1() {
		...
		jsonObject.put("name", "AkshayPalande");
	...
	public void Add_Items_to_Playlist() {
		...
		requestSpecification.contentType("application/json");
		requestSpecification.header("Authorization", token);
		requestSpecification.queryParam("uris",
				"spotify:track:16XEVyPh5NT31CAAqPbxQF,spotify:track:6rkqqLPg9Lbsdh26JMqfp0,spotify:track:6ZRzF7XiZdjnQUDYIk7w7u,spotify:track:7fyIuR4aaWb6iltlAoSkxF,spotify:track:1cpaDNciPGlC39qPs4RkMU");
	...
	public void SearchForItem() {
		...
		requestSpecification.contentType("application/json");
		requestSpecification.header("Authorization", token);
		requestSpecification.queryParam("q", "Arjit singh");
